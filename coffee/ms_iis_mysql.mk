...
MS_IIS_MYSQL_LIB=../js/ludi_ms_iis_mysql_lib.js

TEST_SCRIPT_MS_IIS_MYSQL=t/test_ms_iis_mysql.js

$(MS_IIS_MYSQL_LIB):  $(MS_IIS_MYSQL_OBJECTS)
	$(CSL) ../js/json2.js $(MS_IIS_MYSQL_OBJECTS)$(MINIFY) > $(MS_IIS_MYSQL_LIB)

test_script_ms_iis_mysql: $(MS_IIS_MYSQL_LIB) $(TEST_SOURCES) $(TEST_OBJECTS)
	$(CSL) $(MS_IIS_MYSQL_LIB) ../js/mysql_connect.js $(TEST_OBJECTS) > $(TEST_SCRIPT_MS_IIS_MYSQL)
