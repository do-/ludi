...
V8_V8CGI_SQLITE_LIB=../compiled/ludi_v8_v8cgi_sqlite.js
...
test_script_v8_v8cgi_sqlite: $(V8_V8CGI_SQLITE_LIB) $(TEST_SOURCES) $(TEST_OBJECTS)
	$(CSL) $(V8_V8CGI_SQLITE_LIB) ../local/sqlite_connect.js $(TEST_OBJECTS) > $(TEST_SCRIPT_V8_V8CGI_SQLITE)

test_v8_v8cgi_sqlite: test_script_v8_v8cgi_sqlite
	$(V8_V8CGI_BIN)../core/$(TEST_SCRIPT_V8_V8CGI_SQLITE)
