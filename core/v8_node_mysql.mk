...
V8_NODE_MYSQL_LIB=../compiled/ludi_v8_node_mysql.js
...
test_script_v8_node_mysql: $(V8_NODE_MYSQL_LIB) $(TEST_SOURCES) $(TEST_OBJECTS)
	$(CSL) $(V8_NODE_MYSQL_LIB) ../local/mysql_connect.js $(TEST_OBJECTS) > $(TEST_SCRIPT_V8_NODE_MYSQL)

test_v8_node_mysql: test_script_v8_node_mysql	
	$(V8_NODE_BIN)../core/$(TEST_SCRIPT_V8_NODE_MYSQL)
