...
V8_V8CGI_MYSQL_LIB=../compiled/ludi_v8_v8cgi_mysql.js
...
test_script_v8_v8cgi_mysql: $(V8_V8CGI_MYSQL_LIB) $(TEST_SOURCES) $(TEST_OBJECTS)
	$(CSL) $(V8_V8CGI_MYSQL_LIB) ../local/mysql_connect.js $(TEST_OBJECTS) > $(TEST_SCRIPT_V8_V8CGI_MYSQL)

test_v8_v8cgi_mysql: test_script_v8_v8cgi_mysql	
	$(V8_V8CGI_BIN)../core/$(TEST_SCRIPT_V8_V8CGI_MYSQL)
